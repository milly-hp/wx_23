...
class Ui_GUIWindow(object):
    def setupUi(self, GUIWindow):
        ...
        self.R06BLM4 = QtWidgets.QCheckBox(self.R6Frame)
        self.R06BLM4.setGeometry(QtCore.QRect(0, 70, 81, 20))
        font = QtGui.QFont()
        font.setFamily("Georgia")
        self.R06BLM4.setFont(font)
        self.R06BLM4.setChecked(True)
        self.R06BLM4.setObjectName("R06BLM4")
    ...
    def retranslateUi(self, GUIWindow):
        ...
        GUIWindow.setWindowTitle(_translate("GUIWindow", "MainWindow"))
        ...
        self.R06BLM4.setText(_translate("GUIWindow", "BLM 4"))
...
class MyWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        #Create Button
        button = QtGui.QPushButton("Change z axis")
        button.clicked.connect(self.change_z_axis)
    ...
    def change_z_axis(self):
        ...
        #Create an ew surface plot with updated z-axis
        surface_plot = pg.SurfacePlotItem(x, y, z)
        self.plot_widget.addItem(surface_plot)
        #set the plots z axis range)
        surface_plot.setDataRange(QtCore.Qt.darkBlue, QtCore.Qt.darkRed)
